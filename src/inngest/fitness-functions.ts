...
async function findExistingExercise(prisma: PrismaClient, exerciseName: string, englishName?: string): Promise<any | null> {
     try {
   ...
   function createExerciseData(exercise: any): any {
